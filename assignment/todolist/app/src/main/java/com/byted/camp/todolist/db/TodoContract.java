...
public final class TodoContract {
    ...
    public static final String SQL_CREATE_TODO="CREATE TABLE IF NOT EXISTS "+TodoEntry.TABLE_NAME+"("+
            ...
            TodoEntry.COLUMN_NAME_CONTENT+" TEXT DEFAULT '')";//建表语句

    public static final String SQL_DELETE_TODO=
            "DROP TABLE IF EXISTS "+TodoEntry.TABLE_NAME;//删表语句
